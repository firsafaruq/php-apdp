    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="" class="logo">
          ...
          <span class="logo-mini"><b>SPK</b> ZK</span>
            ...
            <ul class="nav navbar-nav">
              <!-- Messages: style can be found in dropdown.less-->			  
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="../aset/dist/img/cek.jpg" class="user-image" alt="User Image"/>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="../aset/dist/img/cek.jpg" class="img-circle" alt="User Image" />
                   <p>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
         <li style="margin:2%;">
			<table>
			<tr>
			<td rowspan="3"><img src="../aset/dist/img/cek.jpg"style="margin-right:15px;width:45px;height:45px;" class="img-circle" alt="User Image" /></td>
			<th><h4 class="text-blue"><?php echo $_SESSION['nama']; ?><p>(( Walikelas ))</h4>
			</th>
         ...
         <ul class="sidebar-menu">
			...
			<li><a href='?module=siswa' ><i class="fa fa-user-md"></i><span>Data Siswa</span></a></li>
	
			<li><a href='?module=analisa' ><i class="glyphicon glyphicon-briefcase"></i><span>Hasil Rangking</span></a></li>
      ...
      <div style="background:url(../images/0.png)repeat;" class="content-wrapper">
        ...
        <section  class="content-header">
          <h1> Sistem Pendukung Keputusan Pemilihan Calon Peserta OSN
            <small>SMPN6 Kota Tasikmalaya</small>
          </h1>
          <ol class="breadcrumb">
		  <div>
	...
	<?php include "isi.php";?>        		
       ...
       <footer class="main-footer">
        <div class="pull-right hidden-xs">
          Sistem Pendukung Keputusan Pemilihan Calon Peserta OSN Mengunakan Metode SAW<b>Version</b> 1.0
        </div>
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Shinta's Birthday</h4>
          ...
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Andiska Pranata Updated His Profile</h4>

                <p>New phone +62 82217807299</p>
              </div>
            </a>
          </li>
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Andiska Pranata Joined Mailing List</h4>

                <p>andiskap@gmail.com</p>
              </div>
            </a>
          </li>
          <li>
