...
<?php
  ...
  $nextID = "123/V/KEL/".date('m/y')."/".sprintf("%04s",$nextNoUrut);
?>
...
<h3 class="box-title margin text-center">Edit Data Pindah Warga "<?php echo $_GET['id_surat_keterangan']; ?>"</h3>
<hr/>
...
?>
<!----- ------------------------- LIHAT DATA PINDAH ------------------------- ----->
<h3 class="box-title margin text-center">Detail Pindah Warga "<?php echo $_GET['id_surat_keterangan']; ?>"</h3>
<hr/>
